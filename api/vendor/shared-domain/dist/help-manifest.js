...
exports.HELP_MANIFEST_SCREENS = [
    ...
    { id: 'vista_previa_tickets', moduleId: 'admin_operacion', title: 'Vista previa tickets', prioridad: 50, patron: '/vista-previa-impresion(?:/|$)', roles: ['superadmin'], signalOnEnter: 'vista_previa.en_pantalla', route: '/(app)/vista-previa-impresion', viaMoreMenu: false },
