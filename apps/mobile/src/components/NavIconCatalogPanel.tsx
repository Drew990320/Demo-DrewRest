...
type Props = {
  ...
  onClose: () => void;
  /** Panel fijo junto a la barra derecha (tablet+) o modal centrado (móvil). */
...
function CatalogBody({
  ...
  return (
    <>
      ...
      >
        {NAV_APP_ICON_CATEGORIAS.map((cat) => (
...
/** Catálogo de iconos Ionicons agrupados por tema visual. */
export function NavIconCatalogPanel({
  visible,
  value,
  targetLabel,
  onChange,
